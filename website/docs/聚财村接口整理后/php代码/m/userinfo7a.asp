...
if tui_lei=1 then
%>
<span style=" width:50%; float:left;"><a href="userinfo7.asp"><img  src="images/link3a.jpg" width="100%" border="0"  /></a></span><span style=" width:50%; float:left;"><a href="userinfo7b.asp"><img  src="images/link4.jpg" width="100%" border="0"  /></a></span>
<%else%>
<span style=" width:50%; float:left;"><a href="userinfo7.asp"><img  src="images/link3.jpg" width="100%" border="0"  /></a></span><span style=" width:50%; float:left;"><a href="userinfo7b.asp"><img  src="images/link4a.jpg" width="100%" border="0"  /></a></span>
<%end if%>
