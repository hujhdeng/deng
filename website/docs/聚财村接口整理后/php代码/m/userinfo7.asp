...
rs.open "select * from "&u_table&" where web_lei='m2' and lei='1' and lan='1' and tui_lei='1' order by id desc",conn,1,3
...
%>
    ...
    <tr >
    <td ><a href="userinfo7a.asp?id=<%=rs("id")%>">·<%=trim(rs("title"))%></a></td>
  </tr>
  <%
  rs.movenext
  next
