...
<div style="width:100%; ">
<div style=" width:90%; margin:auto;  clear:both;"><input  style="margin-top:1em; background-color:#eee;"   name="tel" type="text" id="tel" onfocus="closewin(this.id)" onblur="showwin(this.id)" value="输入手机号" /></div>
<div style=" width:90%; margin:auto;  clear:both;"><input style=" width:35%; background-color:#eee;" name="yzm" type="text" id="yzm" onfocus="closewin(this.id)" onblur="showwin(this.id)" value="验证码" /> 
<span style="color:#ff6304">【点击获取验证码】</span></div>
