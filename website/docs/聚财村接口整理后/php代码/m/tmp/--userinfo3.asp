...
<div style=" width:100%; float:left;"><img  src="images/u12.jpg" width="100%" border="0"  /></div>

<div style=" width:86%;  background-color:#FFF; border:#d8d8d8 solid 1px; margin:auto; font-size:0.65em;">
...
<div style="width:26%; float:left; color:#000; text-align:right; padding:0.6em;">收款方真实姓名</div>
...
<div style=" width:100%; float:left;"><img  src="images/u13.jpg" width="100%" border="0"  /></div>
<div style=" width:100%; float:left;background-color:#fff;">
<div style="width:26%; float:left; color:#000; text-align:right; padding:0.6em;">支付宝账户</div>
<div style=" width:40%; float:left; "><input name="truename" type="text" id="truename"  /></div><div style=" float:left; color:#fd3b00;  padding:0.6em; ">*(必填)</div>
</div>
<div style=" width:100%; float:left;"><img  src="images/u13.jpg" width="100%" border="0"  /></div>
