...
<span style=" width:50%; float:left;"><img  src="images/link1.jpg" width="100%" border="0"  /></span><span style=" width:50%; float:left;"><img  src="images/link2a.jpg" width="100%" border="0"  /></span>
...
<div style="float:left; width:56%"><img src="images/lmtu1a.jpg" width="100%" /></div>
      ...
      <div style="width:43%; background-color:#d7584f; background-image:url(images/line.jpg); background-repeat:repeat-y;float:left; margin-top:10px;">
...
<div style="float:left; width:74%; margin-left:4px;"><img src="images/lmtu2a.jpg" width="100%" /></div>    
      ...
      <div style="width:57%; background-color:#b64faa;float:left; margin-top:4px;">
...
<div style="float:left; width:56%"><img src="images/lmtu3a.jpg" width="100%" /></div>
            ...
            <div style="width:43%; background-color:#04b2e4; background-image:url(images/line.jpg); background-repeat:repeat-y;float:left; margin-top:4px;">
