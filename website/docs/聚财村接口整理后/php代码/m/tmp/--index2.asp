...
<div style=" width:90%; margin:auto;  clear:both;"><input  style="margin-top:3em;"   name="tel" type="text" id="tel" onfocus="closewin(this.id)" onblur="showwin(this.id)" value="输入您的手机号" /></div>
...
<div style=" width:95%; margin:auto;  clear:both;"><input name="提交" type="button" style=" background-image:url(images/anbk1.jpg);font-weight:bold; color:#FFF; font-size:1em" value="提交" /></div>
<div style=" width:80%;margin:auto;margin-top:1.5em;">
<div style=" width:100%;margin:auto; color:#FFF; padding-top:0.2em;padding-bottom:0.5em; text-align:left" ><a href="userreg.asp">注册推广联盟账户</a></div>
</div>
<div style=" width:80%;margin:auto;margin-top:0.5em;">
<div style=" width:100%;margin:auto; color:#FFF; padding-top:0.5em;padding-bottom:0.5em; text-align:left" >忘记密码？</div>
</div>
<div style=" width:80%;margin:auto;margin-top:1.5em;">
...
function closewin(tmp){
	...
	if(tmp=="tel"){
		if(document.getElementById("tel").value=="输入您的手机号"){
...
function showwin(tmp){
	...
	if(tmp=="tel"){
		if(document.getElementById("tel").value==""){
			document.getElementById("tel").value="输入您的手机号"
			}
		}else if(tmp=="password"){
