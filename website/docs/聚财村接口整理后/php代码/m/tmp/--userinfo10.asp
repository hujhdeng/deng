...
<span style=" width:50%; float:left;"><img  src="images/link5.jpg" width="100%" border="0"  /></span><span style=" width:50%; float:left;"><a href="userinfo7.asp"><img  src="images/link6a.jpg" width="100%" border="0"  /></a></span>
...
<table width="100%" border="0">
    ...
    <td ><a href="userinfo10a.asp">·如果您有理财或贷款需求的朋友，可直接将其个人信息在此</a></td>
  </tr>
      <tr style="color:#797979">
    <td >·处添加。</td>
  </tr>
    <tr style="color:#797979">
    <td >·如果您的朋友通过本平台发生了有效金融消费，平台将以推</td>
  </tr> 
       <tr style="color:#797979">
    <td >·广收入的形式向您支付高额返点佣金。</td>
  </tr> 
</table>
</div>
