...
<div style=" width:100%; float:left;"><img  src="images/u11.jpg" width="100%" border="0"  /></div>
<div style=" width:100%; float:left;background-color:#f0f0f0;">
<div style="width:30%; float:left; color:#000; text-align:right; padding:0.6em; ">是否透露你的推广</div>
...
<p>1.如果您有理财或贷款需求的朋友，可直接将其个人信息在此处添加。如果您的朋友通过本平台发生了有效金融消费，平台将以推广收入的形式向您支付高额返点佣金。</p>
<p>2.我们支持匿名添加有潜在理财或贷款需求的朋友，实现方式为在上面的“是否透露你的推广”栏填写“否”，此情况建议在备注中详细介绍朋友情况。</p>
<p>3.我们更建议您主动添加朋友并告知通过聚财村平台享受金融服务的高性价比，经验证明这样可让您的推广收入提升数倍。</p>
</div>
</div>
