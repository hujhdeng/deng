...
<div class="middlekuang3">
  <img src="images/u19.jpg" width="100%" border="0"  /></div>
</div>
<div class="middlekuang3">
 <form method="post" action=""  id="myform" name="myform">
<div style="width:100%; background-color:#14579d;">
<div style=" width:90%; margin:auto;  clear:both;"><input  style="margin-top:2em;"   name="username" type="text" id="username" onfocus="closewin(this.id)" onblur="showwin(this.id)" value="输入您的手机号" /></div>
...
<div style=" width:95%; margin:auto;  clear:both;"><input name="提交" type="button" style=" background-image:url(images/anbk1.jpg);font-weight:bold; color:#FFF; font-size:1em" value="提交" onclick="chackuser()"/></div>
