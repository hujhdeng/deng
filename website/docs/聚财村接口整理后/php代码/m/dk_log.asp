...
<script>
var imgUrl = 'http://m.jucaicun.com/m/face.jpg';
var lineLink = 'http://m.jucaicun.com/m/weixin.html';
var descContent = "我成为第1021位注册的贷款从业者，赶快来关注我吧";
var shareTitle = '';
...
u_table="dklc_tg"
sql="select * from "&u_table&" where u_tel='"&session("dk_tel")&"'"
...
rs.addnew
rs("u_tracker")=session("tracker_l")
rs("u_name")=session("dk_u_name")
rs("u_tel")=session("dk_tel")
rs("u_money")="0"
rs("tg_money")="0"
rs("tj_money")="0"
end if
...
response.Redirect("dk_logok.asp")
end if
 %>
...
<div style=" width:100%; float:left;"><img  src="images/pic7.jpg" width="100%" border="0"  /></div>
<span style=" width:100%; float:left;"><img  src="images/pic10.jpg" width="100%" border="0" onClick="chackuser()"/></span>
