<?php
$liststr='id,sdanid,uid,regtime,message,u_name,kpno,avatar';
...
mysql_query("set names 'utf8'");
 ...
 //取得记录总数$rs，计算总页数用
 $rs=mysql_query("select * from $u_table where sdanid=$id",$conn);
 ...
 $rs=mysql_query("select * from $u_table where sdanid=".$id." order by id desc limit $offset,$pagesize",$conn);
...
// array_push($arraytmp,'message':urlencode('ok！'));
 if($liststr2[$n]=='avatar'&&is_null($myrow[$liststr2[$n]])!=true){
