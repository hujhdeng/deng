...
$hehasread=0;
if(empty($myrow)){
$sql="INSERT INTO ".$u_table.' (seid,reid,regtime,lastcontent,u_name,kpno,avatar,hasread,hehasread) VALUES ("'.$seid.'","'.$reid.'","'.$regtime.'","'.$content.'","'.$seu_name.'","'.$sekpno.'","'.$seavatar.'","'.$hasread.'","'.$hehasread.'")';	
	}else{
