<?php
$liststr='id,seid,reid,regtime,lastcontent,u_name,kpno,avatar,hehasread';
$u_table='chat_user';
$uid = $_GET["uid"];//发信
...
mysql_query("set names 'utf8'");
 ...
 $rs=mysql_query("select * from $u_table  where reid=".$uid."  order by regtime desc limit $offset,$pagesize",$conn);
...
}else if($liststr2[$n]=='hehasread'){
$arraytmp['hasread']=urlencode($myrow[$liststr2[$n]]);
	}else{
