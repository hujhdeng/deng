	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (act.equals("bind")) {
			...
			.append(req.getParameter("uid") + "-"
					+ req.getParameter("pushid")).append("bind success").flush();
...
//			BaiduPushUtil.ipush(pushid, msg);
			...
			resp.getWriter().append(push).flush();
...
//			BaiduPushUtil.apush(pushid, msg);
			...
			if (idAndType[1].equals("3")) {
				// BaiduPushUtil.apush(idAndType[0],msg);
				 push = AndroidPushMessageSample.push(idAndType[0], msg);
			} else {
				// BaiduPushUtil.ipush(idAndType[0],msg);
				 push = IosPushNotificationSample.push(idAndType[0], msg);
			}
			resp.getWriter().append(push).flush();
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		String msg1 = (String) req.getParameter("msg");
